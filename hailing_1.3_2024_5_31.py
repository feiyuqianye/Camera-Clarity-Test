...
class BlurDetection:
    def __init__(self):
        ...
        # 阈值
        self.energy_gradient_threshold = 32050 #32050
        self.laplacian_threshold = 3105        #3105
        self.brenner_threshold = 701           #701
...
class App:
    def __init__(self, root):
        ...
        # 创建窗口组件
        self.canvas = tk.Canvas(root, width=716, height=600)#869,700
    ...
    def update_image(self):
        ...
        if ret:
            ...
            # 计算矩形的宽度和高度
            rect_width = int(width * 0.5)  # 矩形的宽度
            rect_height = int(height * 0.5)  # 矩形的高度
            # 绘制矩形区域为白色
            ...
            # 放大
            enlarged_frame = cv2.resize(blended_frame, (713, 592))  # 修改放大尺寸960,768，1360*768-613*492
            # 在图片中心添加红色十字架
